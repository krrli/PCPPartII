...
public class PostmanParser extends Parser {
	...
	public PostmanParser(TokenStream input) {
		super(input);
	...
	public static class SatzContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof PostmanListener ) ((PostmanListener)listener).enterSatz(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof PostmanListener ) ((PostmanListener)listener).exitSatz(this);
		}
	}
	...
	public static class SubjektContext extends ParserRuleContext {
		...
		public SubjektContext() { }
		public void copyFrom(SubjektContext ctx) {
			super.copyFrom(ctx);
		}
	}
	public static class SubjectArtSubstContext extends SubjektContext {
		...
		public SubjectArtSubstContext(SubjektContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof PostmanListener ) ((PostmanListener)listener).enterSubjectArtSubst(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof PostmanListener ) ((PostmanListener)listener).exitSubjectArtSubst(this);
		}
	}
	...
	public final SubjektContext subjekt() throws RecognitionException {
		...
		try {
			_localctx = new SubjectArtSubstContext(_localctx);
			enterOuterAlt(_localctx, 1);
			{
			setState(18);
			artikel();
	...
	public static class ObjektContext extends ParserRuleContext {
		...
		public ObjektContext() { }
		public void copyFrom(ObjektContext ctx) {
			super.copyFrom(ctx);
		}
	}
	public static class ObjectArtSubstContext extends ObjektContext {
		public ArtikelContext artikel() {
			return getRuleContext(ArtikelContext.class,0);
		}
		public SubstantivContext substantiv() {
		...
		public ObjectArtSubstContext(ObjektContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof PostmanListener ) ((PostmanListener)listener).enterObjectArtSubst(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof PostmanListener ) ((PostmanListener)listener).exitObjectArtSubst(this);
		}
	}
	...
	public final ObjektContext objekt() throws RecognitionException {
		...
		try {
			_localctx = new ObjectArtSubstContext(_localctx);
			enterOuterAlt(_localctx, 1);
			{
			setState(21);
			artikel();
	...
	public static class PraedikatContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof PostmanListener ) ((PostmanListener)listener).enterPraedikat(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof PostmanListener ) ((PostmanListener)listener).exitPraedikat(this);
		}
	}
	...
	public static class SubstantivContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof PostmanListener ) ((PostmanListener)listener).enterSubstantiv(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof PostmanListener ) ((PostmanListener)listener).exitSubstantiv(this);
		}
	}
	...
	public static class VerbContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof PostmanListener ) ((PostmanListener)listener).enterVerb(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof PostmanListener ) ((PostmanListener)listener).exitVerb(this);
		}
	}
	...
	public static class ArtikelContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof PostmanListener ) ((PostmanListener)listener).enterArtikel(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof PostmanListener ) ((PostmanListener)listener).exitArtikel(this);
		}
	}
	...
	public static final String _serializedATN =
		...
		"\2\4\3\2\3\4\3\2\6\7\2\33\2\20\3\2\2\2\4\24\3\2\2\2\6\27\3\2\2\2\b\32"+
		"\3\2\2\2\n\34\3\2\2\2\f\36\3\2\2\2\16 \3\2\2\2\20\21\5\4\3\2\21\22\5\b"+
		"\5\2\22\23\5\6\4\2\23\3\3\2\2\2\24\25\5\16\b\2\25\26\5\n\6\2\26\5\3\2"+
		"\2\2\27\30\5\16\b\2\30\31\5\n\6\2\31\7\3\2\2\2\32\33\5\f\7\2\33\t\3\2"+
		"\2\2\34\35\t\2\2\2\35\13\3\2\2\2\36\37\7\5\2\2\37\r\3\2\2\2 !\t\3\2\2"+
		"!\17\3\2\2\2\2";
