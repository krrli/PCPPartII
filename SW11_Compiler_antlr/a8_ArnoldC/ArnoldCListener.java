...
public interface ArnoldCListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link ArnoldCParser#comment}.
	 * @param ctx the parse tree
	 */
	void enterComment(ArnoldCParser.CommentContext ctx);
	/**
	 * Exit a parse tree produced by {@link ArnoldCParser#comment}.
	 * @param ctx the parse tree
	 */
	void exitComment(ArnoldCParser.CommentContext ctx);
}